 ...
 * 类描述：   产品类型实现类
 * 创建人：tim   
 * 创建时间：2010-8-5 下午01:40:25   
 * 修改人：tim   
 * 修改时间：2010-8-5 下午01:40:25   
 * 修改备注：   
 * @version    
 *    
 */

public class TypeService extends FrmService implements ITypeService{
	...
	public TypeData retrieveType(String id) throws KINGException{
		TypeData u=typeDao.retrieve(id);
		return u;
	}
	...
	public List<TypeData> searchTypes(PageRoll pageRoll,String withsql) throws KINGException{
		...
		pageRoll.setCountSQL(CountSQL);
		pageRoll.setSearchSQL(hql.toString());
		List list = typeDao.searchlist(pageRoll,withsql);
		return list;
	}
