...
public class KINGException extends Exception implements IKINGException{
	...
	public KINGException(String code, String cause, String name, String solution) {
		this.errorCode = code;
	...
	public KINGException(Exception errorRoot){
		this.errorRoot=errorRoot;
	}
	
	public KINGException(String errorCode) {
		this.errorCode = errorCode;
		make();
	}
	
	public KINGException(String errorCode, String parameters) {
	...
	public KINGException(String errorCode, Exception errorRoot) {
	...
	private void make() {
		...
		KINGException ex = exCache.getException(errorCode);
		if (ex == null){
			ex = new KINGException(errorCode,"","","");
			exCache.updateCache(errorCode, ex);
			try{
				exCache.saveCache();
			}catch(KINGException vwpEx){
